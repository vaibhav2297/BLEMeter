...
object ZeroInitialiseCommand : Command<MeterDataRequest, MeterData>(
    ...
    override val requestLength: UInt = 0x04u

    override val dataIdentifier: DataIdentifier = DataIdentifier.ZERO_INITIALISATION
