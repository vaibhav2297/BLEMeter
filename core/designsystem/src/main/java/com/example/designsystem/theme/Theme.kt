...
private val DarkColorScheme = AppColors(
    brand = BLEColors.Primary,
    background = BLEColors.Background,
    onBackground = BLEColors.White,
    textPrimary = BLEColors.White,
    textHighlighted = BLEColors.Grey,
    success = BLEColors.Primary,
    error = BLEColors.Red,
    stroke = BLEColors.Stroke
)

private val LightColorScheme = AppColors(
    brand = BLEColors.Primary,
    background = BLEColors.White,
    onBackground = BLEColors.Background,
    textPrimary = BLEColors.Black,
    textHighlighted = BLEColors.Grey,
    success = BLEColors.Primary,
    error = BLEColors.Red,
    stroke = BLEColors.Stroke
